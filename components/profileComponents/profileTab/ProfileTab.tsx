...
import TelegramIntegrations from '@/components/profileComponents/profileTab/TelegramIntegrations';
...
export function ProfileTab({
    ...
    return (
        <div className="flex flex-col gap-5">
            ...
            <TelegramIntegrations telegramChatId={user.telegram_chat_id} />
        </div>
    );
}

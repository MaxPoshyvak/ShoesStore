            ...
            <div className={styles.navbar__actions}>
                ...
                {pathname === '/shop' && (
                    <div style={{ position: 'relative' }}>
                        ...
                        >
                            <Image src="/filter.svg" alt="Filter" width={24} height={24} className={styles.iconImage} />
                        </button>
                ...
                <button className={styles["navbar__btn-search"]}>
                    <Image src="/search.png" alt="Search" width={21} height={21} className={styles.iconImage} />
                </button>
                ...
                >
                    <div id="cart-icon-target" className={styles.cartWrapper}>
                        <Image src="/trolley.png" alt="Cart" width={30} height={30} className={styles.iconImage} />
                        <span
